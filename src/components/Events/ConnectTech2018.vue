                ...
                <div class="card">
                  <img src="../../assets/atlanta.jpg" class="card-img-top"/>    
                    <div class="card-body">
                     ...
                     <p align="center">
                         <b-button size="lg" variant="success" href="https://ladeezfirstmedia.typeform.com/to/F4q5Mq">Attendee Registration</b-button>
                         <b-button size="lg" variant="success" href="https://ladeezfirstmedia.typeform.com/to/Hw40DL">Mentor Registration</b-button>
                      </p>
