              ...
              <b-col md="8" offset-md="2">
                <div class="card">
                  <img src="../../assets/atlanta.jpg" class="card-img-top"/>    
                    <div class="card-body">
                      <h4 class="title"><p align="center">We Rise Conference, Atlanta, June 21-22 2018</p></h4>
                      <p>
                        We are hosting a full-day workshop for web and mobile development with Vue.js. 
                        Free to all who attend! More details on our schedule will be posted here soon.
                      </p>
                      <p align="center">
