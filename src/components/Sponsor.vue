                ...
                <div class="card">   
                  <img src="../assets/pretty-fox.jpg" class="card-img-top"/>
                    <div class="card-body">
                      ...
                      <p>If you are organizing an event, consider adding to your diversity offerings by offering a free Vue Vixens workshop
                        to people who identify as women. One model that works is to offer your paid workshops before your conference, then offer 
                        Vue Vixens workshops after the event. Workshops are a full-day event, free to registered participants and low-cost to you. 
                      ...
                      <ul>
                        ...
                        <li>🦊 Mentors drawn from conference speakers. We will work to recruit them if you can provide a list!</li>
                      </ul>
