<template>
  <b-navbar toggleable="md"  type="dark" variant="dark" class="navbar-dark bd-navbar" sticky>
    ...
    <b-collapse is-nav class="justify-content-between" id="bd-main-nav">
      ...
      <b-navbar-nav>
        <b-nav-item href="http://progress.com" target="_blank">A Project by Progress Developer Relations</b-nav-item>
      ...
      <b-navbar-nav>
        ...
        <b-nav-item href="https://github.com/vuevixens" target="_blank">
          <svg class="navbar-nav-svg" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 499.36" focusable="false">
            <title>GitHub</title>
        ...
        <b-nav-item href="https://slackin-fxsumkvfno.now.sh/" target="_blank">
          <svg class="navbar-nav-svg" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" focusable="false">
            <title>Slack</title>
