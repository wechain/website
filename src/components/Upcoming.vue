                ...
                <article class="card">
                  <img src="../assets/skulk.png" class="card-img-top"/>
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list">
                        <li class="list-item">🦊 <a href="https://progress.com/next">Progress Next Conference</a> - Boston - May 31 - June 1, 2018<br/>
                          We are hosting a mini skulk lunch and learn for mobile development with Vue.js. Come meet amazing Progress women!
                        </li>
